...
$wp_customize->add_section( 'header_banner_section',
    array(
    'title'      => esc_html__( 'Header Banner', 'the-blip' ),
...
$wp_customize->add_control('ed_header_banner',
    array(
        'label' => esc_html__('Enable Banner Section', 'the-blip'),
...
$wp_customize->add_control('ta_header_banner_category',
    array(
        'label' => esc_html__('Header Banner Category', 'the-blip'),
        'section' => 'header_banner_section',
        'type' => 'select',
...
$wp_customize->add_control('ta_header_banner_layout',
    array(
        'label' => esc_html__('Header Banner Layout', 'the-blip'),
        'section' => 'header_banner_section',
        'type' => 'select',
        'choices' => array(
...
$wp_customize->add_section( 'featured_category_section',
    array(
    'title'      => esc_html__( 'Featured Category Section', 'the-blip' ),
    'capability' => 'edit_theme_options',
    'panel'      => 'the_words_home_panel',
    )
);
...
$wp_customize->add_control('ed_featured_category_section',
    array(
        'label' => esc_html__('Enable Featured Category Section', 'the-blip'),
...
$wp_customize->add_control('ta_featured_categoey_1',
    array(
        'label' => esc_html__('Featured Category One', 'the-blip'),
        'section' => 'featured_category_section',
        'type' => 'select',
        'choices' => $the_words_cat_list,
    )
...
$wp_customize->add_control('ta_featured_categoey_2',
    array(
        'label' => esc_html__('Featured Category Two', 'the-blip'),
        'section' => 'featured_category_section',
        'type' => 'select',
        'choices' => $the_words_cat_list,
    )
...
$wp_customize->add_control('ta_featured_categoey_3',
    array(
        'label' => esc_html__('Featured Category Three', 'the-blip'),
        'section' => 'featured_category_section',
        'type' => 'select',
        'choices' => $the_words_cat_list,
    )
