<?php
/**
 * Personnalisation du thème The BLIP.
 *
 * @package The_BLIP
 */
...
function the_words_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('enable_site_title',
	    array(
	        'label' => esc_html__('Display Site Title and Tagline', 'the-blip'),
	...
	$wp_customize->add_panel( 'the_words_general_panel',
		array(
			'title'      => esc_html__( 'General Settings', 'the-blip' ),
			'priority'   => 5,
			'capability' => 'edit_theme_options',
		)
	);
	...
	$wp_customize->add_panel(
    	...
    	array(
        	...
        	'capability'     => 'edit_theme_options',
        	'theme_supports' => '',
        	'title'          => esc_html__( 'Front Page Settings', 'the-blip' ),
        ) 
    );

	$wp_customize->add_panel( 'theme_option_panel',
		array(
			'title'      => esc_html__( 'Theme Options', 'the-blip' ),
			'priority'   => 10,
			'capability' => 'edit_theme_options',
		)
	);
