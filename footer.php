...
?>
	...
	<footer id="colophon" class="site-footer" itemscope itemtype="http://schema.org/WPFooter">
		...
		if ( is_active_sidebar( 'the-words-footer-1' ) ||
			...
			if ( is_active_sidebar( 'the-words-footer-1' ) || is_active_sidebar( 'the-words-footer-2' ) || is_active_sidebar( 'the-words-footer-3' ) ) {
				...
				for ( $x = 0; $x <= 3; $x++ ) {
					if ( is_active_sidebar( 'the-words-footer-' . $x ) ) {
										...
										echo '<div id="ta-footer-widget-' . absint( $x ) . '" class="ta-footer-widget glass-card">';
...
<?php
$ed_footer_go_top_button = get_theme_mod( 'ed_footer_go_top_button', 1 );
