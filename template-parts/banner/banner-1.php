					...
					while ( $banner_post_query->have_posts() ) {
						...
						<div class="ta-banner-iteam">
							<div class="ta-iteam-secondary">
								...
								<div class="ta-banner-content ta-bg-height-1" 
								<?php
								if ( $banner_post_image ) {
									?>
									style="background-image: url(<?php echo esc_url( $banner_post_image ); ?> );" <?php } ?> ></div>

								<div class="ta-content-absolute-2">

																		<header class="entry-header">
																				<?php the_words_entry_footer( true, false, false, false, 2 ); ?>
																		</header><!-- .entry-header -->
